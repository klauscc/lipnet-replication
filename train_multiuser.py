...
weight_savepath = './data/checkpoints/lipnet_weights_{}_{}.hdf5'.format(name, timestamp)
log_savepath='./data/logs/lipnet_loss_seen_{}_{}.csv'.format(name, timestamp)
log_savepath_unseen = './data/logs/lipnet_loss_unseen_{}_{}.csv'.format(name, timestamp)
